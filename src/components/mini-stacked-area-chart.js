...
/**
 * Renders multiple series as stacked cumulative layers with animations and interactions.
 *
...
:host([interactive]) [part="layers"]:has([part~="layer"]:hover) [part~="layer"]:not(:hover) {
  ...
  #updateChart(data) {
    ...
    const isNormalized = this.hasAttribute("normalize");
    const offset = isNormalized ? "expand" : "none";

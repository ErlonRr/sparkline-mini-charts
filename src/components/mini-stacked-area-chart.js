// mini-stacked-area-chart.js — Responsive SVG stacked area sparkline Custom Element.
...
/**
 * Renders multiple data series as stacked area chart layers.
 *
 * @extends MiniChartElement
 */
export class MiniStackedAreaChart extends MiniChartElement {
  /** @type {boolean} */
  #initialized = false;
...
:host { 
  ...
  --mini-chart-color-2: hsl(282 83% 65%);
  --mini-chart-color-3: hsl(302 83% 72%);
  --mini-chart-color-4: hsl(322 83% 79%);
}
[part="layer"] { 
...
[part="layer"]:nth-child(4) { fill: var(--mini-chart-color-4); }`;
    ...
    const maskId = `stacked-mask-${Math.random().toString(36).slice(2)}`;

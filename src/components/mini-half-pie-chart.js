// mini-half-pie-chart.js — Responsive SVG half-pie sparkline Custom Element.
...
/**
 * Renders non-negative values as an upper half-pie sparkline with animations.
 *
...
export class MiniHalfPieChart extends MiniChartElement {
  ...
  render() {
    ...
    if (!svg || !style) {
      ...
      const maskId = `half-pie-mask-${Math.random().toString(36).slice(2)}`;
      ...
      const maskCircle = createSvgElement("circle", { 
        ...
        "stroke-dasharray": "78.6", "stroke-dashoffset": "78.6",
